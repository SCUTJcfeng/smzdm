...
# 好价
# HAOJIA_API = 'https://api.smzdm.com/v1/common/list_data?params={"common_type":1}&tab_params={"tab":"haojia","channel":"haojia","keyword":"{}","keyword_type":"category"}&filter_params={"filter":"faxian"}&page=1'
